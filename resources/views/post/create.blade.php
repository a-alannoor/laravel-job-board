    ...
    <form method="POST" action="/post">
        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <p class="mt-1 text-sm/6 text-gray-600">This information will be displayed your new post.</p>
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            <input type="text" name="title" value="{{ old('title') }}" id="title" autocomplete="given-name"
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            <input type="text" name="author" value="{{ old('author') }}" id="author" autocomplete="family-name"
                    ...
                    <div class="col-span-full">
                        ...
                        <p class="mt-3 text-sm/6 text-gray-600">Write a few sentences body post.</p>
                        @error('body')
                            <span class="text-red-500">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="col-span-full">
                        <div class="flex gap-3">
                            ...
                            <div class="text-sm/6">
                                ...
                                <p id="published-description" class="text-gray-500">Set checked when the post
                                    is published already.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            <a href="/post" class="text-sm/6 font-semibold text-gray-900">Cancel</a>
            <button type="submit"
